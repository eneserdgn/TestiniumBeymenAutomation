...
public class ElementHelper {
    ...
    public String getTextFromCell(String sheet, int row, int column) {
        System.out.println(excelHelper.getTextFromCell(sheet, row, column));
        return excelHelper.getTextFromCell(sheet, row, column);
    }
